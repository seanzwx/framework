...
import com.sean.ds.service.ClientListener;

/**
 * A Netty-based RPC {@link Server} implementation.
 */
@SuppressWarnings("unused")
public class DsNettyServer implements Server
{
	...
	public DsNettyServer(Responder responder, InetSocketAddress addr)
	{
		this(responder, addr, new NioServerSocketChannelFactory(Executors.newCachedThreadPool(), Executors.newCachedThreadPool()));
	}

	public DsNettyServer(Responder responder, InetSocketAddress addr, ChannelFactory channelFactory)
	{
	 ...
	 */
	public DsNettyServer(Responder responder, InetSocketAddress addr, ChannelFactory channelFactory, final ChannelPipelineFactory pipelineFactory,
	 ...
	 *                         ExecutionHandler javadoc).
	 */
	public DsNettyServer(Responder responder, InetSocketAddress addr, ChannelFactory channelFactory, final ExecutionHandler executionHandler)
	{
	...
	class NettyServerAvroHandler extends SimpleChannelUpstreamHandler
	{
		...
		public void channelOpen(ChannelHandlerContext ctx, ChannelStateEvent e) throws Exception
		{
			...
			{
				clientListener.onConnected(e.getChannel());
			}
		}
		...
		public void channelClosed(ChannelHandlerContext ctx, ChannelStateEvent e) throws Exception
		{
			...
			if (clientListener != null)
			{
				clientListener.onDisconnected(e.getChannel());
			}
		}
